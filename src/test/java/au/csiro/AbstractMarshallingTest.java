...
public abstract class AbstractMarshallingTest<T>
{
    ...
    /**
     * Allow the implementing test to run some verification of the object deserialised from JSON
     * 
     * @param testObj
     *            The original object used in the test
     * @param deserObj
     *            The object created from the json serialisation and deserialisation  of the original object.
     */
    protected void validateJsonDeserialisedObject(T testObj, T deserObj)
    {
        // No generic tests
    }
     ...
     *            The original object used in the test
     * @param deserObj
     *            The object created from the json serialisation of the original object.
     */
    protected void validateJsonSerialisedObject(T testObj, Map<String, Object> map)
    {
        // No generic tests
    }
    ...
    public void testJsonSerialization() throws Exception
    {
        ...
        Map<String, Object> jsonMap = (Map<String, Object>) getObjectFromJson(mapper, Map.class, json);
        validateJsonSerialisedObject(testObj, jsonMap);

        @SuppressWarnings("unchecked")
        T deserObj = (T) getObjectFromJson(mapper, testObj.getClass(), json);
        validateJsonDeserialisedObject(testObj, deserObj);
    ...
    protected String getJsonFromObject(ObjectMapper mapper, T testObj) throws IOException, JsonGenerationException,
    ...
    {
        T testObj = getTestObject();
        assertTrue(testObj instanceof Serializable);
        String string = toString((Serializable) testObj);
        T deserObj = fromString(string);
     ...
     */
    private T fromString(String s) throws IOException, ClassNotFoundException
    {
