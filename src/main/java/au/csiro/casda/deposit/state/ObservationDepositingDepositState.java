 ...
 */
public class ObservationDepositingDepositState extends ParentDepositableArtefactDepositingDepositState
{
    /**
     * Constructor, sets the successful transition to NOTIFYING.
     * 
     * @param stateFactory
     ...
     *            the artefact
     */
    public ObservationDepositingDepositState(DepositStateFactory stateFactory,
            ParentDepositableArtefact parentDepositableArtefact)
    {
        super(stateFactory, parentDepositableArtefact, Type.NOTIFYING);
    }
}
