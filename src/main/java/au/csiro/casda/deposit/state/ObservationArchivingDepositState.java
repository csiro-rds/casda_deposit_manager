 ...
 */
public class ObservationArchivingDepositState extends CasdaArchivingDepositState
{
    /**
     * Constructor
     * 
     ...
     */
    protected ObservationArchivingDepositState(DepositStateFactory stateFactory,
    ...
    {
        return DepositManagerEvents.E088.messageBuilder().add(this.getDepositable().getFilename())
                            .add(this.getDepositable().getParent().getUniqueId())
                            .add(this.getDepositable().getDepositState().getType().name()).toString();
    }
